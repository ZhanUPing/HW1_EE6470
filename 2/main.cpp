...
int sc_main(int argc, char **argv)
{
  ...
  sc_fifo<unsigned char> img_width;
  ...
  sobel_filter.i_g(g);
  sobel_filter.i_b(b);
  sobel_filter.i_img_width(img_width);

  sobel_filter.o_avg_r(result_r);
  sobel_filter.o_avg_g(result_g);
  sobel_filter.o_avg_b(result_b);
